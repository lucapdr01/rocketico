...
contract('RocketToken', function(accounts){
    var tokenInstance;
    it ('initializes the contract', function() {
        return RocketToken.deployed().then(function(instance){
            ...
            assert.equal(name, 'Rocket Token','correct name' );
            return tokenInstance.symbol();
        }).then(function(symbol) {
            assert.equal(symbol, 'RC', 'correct symbol');
            return tokenInstance.standard();
        }).then(function(standard) {
            assert.equal(standard, 'Rocket Token v0.1', 'correct standard');
        });
    });
