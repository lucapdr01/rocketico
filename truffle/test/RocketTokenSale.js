...
contract('RocketTokenSale', function(accounts) {
  var tokenInstance;
  ...
  it('initializes the contract with the correct values', function() {
    return RocketTokenSale.deployed().then(function(instance) {
  ...
  it('facilitates token buying', function() {
    return RocketToken.deployed().then(function(instance) {
      // Grab token instance first
      tokenInstance = instance;
      return RocketTokenSale.deployed();
  ...
  it('ends token sale', function() {
    return RocketToken.deployed().then(function(instance) {
      ...
      assert.equal(balance.toNumber(), 999990, 'returns all unsold rocket tokens to admin');
      // Check that the contract has no balance
      web3.eth.getBalance(tokenSaleInstance.address).then(balance => {
